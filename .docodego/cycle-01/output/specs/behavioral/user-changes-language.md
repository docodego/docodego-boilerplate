...
- [user-changes-language-on-mobile](user-changes-language-on-mobile.md) — Defines the mobile-specific language switching flow using `I18nManager.forceRTL()` and app restart for RTL layout changes, complementing the web-based language selector defined in this specification
